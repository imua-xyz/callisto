...
replace (
	...
	// todo: remove this after merging the reward-compounding PR
	github.com/imua-xyz/imuachain => github.com/TimmyExogenous/imuachain v0.0.0-20251021072531-461b17e296fe
